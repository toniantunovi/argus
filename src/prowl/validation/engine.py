...
class ValidationEngine:
    ...
    async def _validate_finding(self, finding: Finding, target: Target, stats: ValidationStats) -> None:
        ...
        async with self.limiter:
            ...
            finding.validation_strategy = "build_project"
            # Store the test script as the reproducible artifact
            if outcome.test_script:
                finding.poc_code = outcome.test_script
            elif outcome.poc_code:
